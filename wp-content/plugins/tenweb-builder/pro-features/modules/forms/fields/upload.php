...
class Upload extends Field_Base {
	...
	private function get_blacklist_file_ext() {
		...
		if ( ! $blacklist ) {
			 ...
			 */
			$blacklist = apply_filters( 'elementor_tenweb/forms/filetypes/blacklist', $blacklist );
		}
	...
	private function get_upload_dir() {
		 ...
		 */
		$path = apply_filters( 'elementor_tenweb/forms/upload_path', $path );
	...
	private function get_file_url( $file_name ) {
		 ...
		 */
		$url = apply_filters( 'elementor_tenweb/forms/upload_url', $url, $file_name );
	...
	public function __construct() {
		parent::__construct();
		add_action( 'elementor_tenweb/forms/process', [ $this, 'set_file_fields_values' ], 10, 2 );
	}
}
