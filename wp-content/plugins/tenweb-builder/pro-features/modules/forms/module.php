<?php
namespace Tenweb_Builder\ElementorPro\Modules\Forms;

use Elementor\Controls_Manager;
use Tenweb_Builder\ElementorPro\Core\Utils;
use Tenweb_Builder\ElementorPro\Modules\Forms\Data\Controller;
use Elementor\Core\Experiments\Manager;
use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
use Tenweb_Builder\ElementorPro\Base\Module_Base;
use Tenweb_Builder\ElementorPro\Modules\Forms\Actions;
use Tenweb_Builder\ElementorPro\Modules\Forms\Classes;
use Tenweb_Builder\ElementorPro\Modules\Forms\Controls\Fields_Map;
use Tenweb_Builder\ElementorPro\Modules\Forms\Registrars\Form_Actions_Registrar;
use Tenweb_Builder\ElementorPro\Modules\Forms\Registrars\Form_Fields_Registrar;
use Tenweb_Builder\ElementorPro\Modules\Forms\Submissions\Component as Form_Submissions_Component;
...
//			'Login',
	...
	public function __construct() {
		...
		if ( Classes\Ajax_Handler::is_form_submitted() ) {
			 ...
			 */
			do_action( 'elementor_tenweb/forms/form_submitted', $this );
		}
	}
}
