<?php
namespace Tenweb_Builder\ElementorPro\Modules\AssetsManager\AssetTypes\Icons;

use Elementor\Core\Utils\Exceptions;
use Tenweb_Builder\ElementorPro\Core\Utils;
use Tenweb_Builder\ElementorPro\Modules\AssetsManager\Classes\Assets_Base;
use Tenweb_Builder\ElementorPro\Modules\AssetsManager\AssetTypes\Icons_Manager;
...
class Custom_Icons extends  Assets_Base {
	...
	public static function get_supported_icon_sets() {
		...
		$additional_icon_sets = apply_filters( 'elementor_tenweb/icons_manager/custom_icons/additional_supported_types', $additional_icon_sets );
	...
	public function register_ajax_actions( Ajax $ajax ) {
		$ajax->register_ajax_action( 'twbb_assets_manager_custom_icon_upload', [ $this, 'custom_icons_upload_handler' ] );
	}
	...
	public function add_custom_icon_templates( $current_screen ) {
		...
		\Elementor\Plugin::instance()->common->add_template( __DIR__ . '/templates.php' );
	}
