...
use Tenweb_Builder\ElementorPro\Modules\AssetsManager\Classes\Font_Base;
...
class Typekit_Fonts extends Font_Base {
	...
	protected function actions() {
		...
		add_action( 'wp_ajax_tenweb_builder_admin_fetch_fonts', [ $this, 'integrations_admin_ajax_handler' ] );
	}
}
