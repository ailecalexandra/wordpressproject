...
class PopupTemplates {
  ...
  */
  public function twbb_dublicate_teplate_post(){
    ...
    $page_title = Helper::get('page_title');
    $template_type = Helper::get('template_type');
     ...
     */
    $post_id = absint( Helper::get('post'));
    /*
    ...
    if (isset( $post ) && $post != null) {
      ...
      $params['page_type'] = Helper::get('page_type');
      $params['specific_page'] = Helper::get('current_post');
  ...
  public function twbb_save_templates( $param = "" ) {
    $data = array(
      'post' => Helper::get('current_post_id'),
      'page_type' => Helper::get('page_type'),
      'templates' => array(
                      'twbb_header'   => Helper::get('header_template'),
                      'twbb_single'   => Helper::get('single_template'),
                      'twbb_archive'  => Helper::get('archive_template'),
                      'twbb_footer'   => Helper::get('footer_template'),
                    )
    );
