...
class Condition {
  ...
  public function __construct(){
    include_once 'condition-item.php';
  ...
  public function condition_popup(){
    include_once 'views/condition-popup.php';
  }
  ...
  private function set_page_conditions() {
    ...
    $conditions = get_option('twbb_' . $this->page_type . '_conditions', []);
  ...
  private function get_template_valid_conditions($template_conditions, $template_id){
    $valid_conditions = [];
  ...
  private function get_condition_by_template_type($template_type) {
    if(empty($this->page_conditions)) {
      return null;
    }
    ...
    $max_level = 0;
    $condition_obj = null;
    foreach($this->page_conditions as $template_id => $conditions) {
