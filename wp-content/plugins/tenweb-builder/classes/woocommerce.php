...
//      'price-filter',
  ...
  public function after_enqueue_scripts() {
    ...
    wp_enqueue_script('twbb-woocommerce-my-account-script', TWBB_URL . '/widgets/woocommerce/my-account/assets/script.js', ['twbb-woocommerce-base'], TWBB_VERSION);
    wp_enqueue_script('twbb-woocommerce-cart-script', TWBB_URL . '/widgets/woocommerce/cart/assets/script.js', ['twbb-woocommerce-base'], TWBB_VERSION);
    wp_enqueue_script('twbb-woocommerce-checkout-script', TWBB_URL . '/widgets/woocommerce/checkout/assets/script.js', ['twbb-woocommerce-base'], TWBB_VERSION);
    wp_enqueue_script('twbb-woocommerce-notices-script', TWBB_URL . '/widgets/woocommerce/notices/assets/script.js', [], TWBB_VERSION);
    wp_enqueue_script('twbb-woocommerce-purchase-summary-script', TWBB_URL . '/widgets/woocommerce/purchase-summary/assets/script.js', [], TWBB_VERSION);
  }
    ...
    private function should_load_wc_notices_styles() {
        ...
        $is_editor = self::_unstable_get_super_global_value( $_GET, 'elementor-preview' );
