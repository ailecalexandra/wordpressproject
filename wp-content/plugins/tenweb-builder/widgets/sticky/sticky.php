...
class Sticky extends Widget_Base  {
   ...
   */
    ...
    $element->start_controls_section(
			'tenweb_section_scrolling_effect',
			[
				'label' => __( 'Scrolling Effect', 'tenweb-builder' ),
	...
	private function add_actions() {
		add_action( 'elementor/element/section/section_effects/before_section_start', [ $this, 'register_custom_controls' ] );
		add_action( 'elementor/element/container/section_effects/before_section_start', [ $this, 'register_custom_controls' ] );
		add_action( 'elementor/element/common/section_effects/before_section_start', [ $this, 'register_custom_controls' ] );
	}
}
