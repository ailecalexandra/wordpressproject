...
class Author_Box extends Widget_Base {
  ...
  protected function render() {
    ...
    <?php if ( $print_avatar ) { ?>
      <<?php echo $link_tag; ?> <?php echo $this->get_render_attribute_string( 'author_link' ); ?> class="elementor-author-box__avatar" <?php echo $this->get_render_attribute_string( 'avatar_target' ); ?> <?php echo $this->get_render_attribute_string( 'avatar_nofollow' ); ?>>
    ...
    <?php if ( $print_name ) : ?>
      <<?php echo $link_tag; ?> <?php echo $this->get_render_attribute_string( 'author_link' ); ?> <?php echo $this->get_render_attribute_string( 'avatar_target' ); ?> <?php echo $this->get_render_attribute_string( 'avatar_nofollow' ); ?>>
    ...
    <?php if ( $print_link ) : ?>
      <a <?php echo $this->get_render_attribute_string( 'button' ); ?> <?php echo $this->get_render_attribute_string( 'button_target' ); ?> <?php echo $this->get_render_attribute_string( 'button_nofollow' ); ?>>
