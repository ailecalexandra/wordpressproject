...
class PostsArchive extends Posts {
  ...
  protected function get_query_args(){
    ...
    if(Templates::get_instance()->is_twbb_template()['template_type']) {
      ...
      $query_args['tax_query'] = (!empty($wp_query->tax_query->queries)) ? $wp_query->tax_query->queries : [];
      $query_args['meta_query'] = (!empty($wp_query->meta_query->queries)) ? $wp_query->meta_query->queries : [];
