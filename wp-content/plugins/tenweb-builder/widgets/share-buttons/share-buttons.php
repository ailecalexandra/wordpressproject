  ...
  protected function register_controls() {
    ...
    $this->add_control(
      ...
      [
        ...
        'title_field' => '<i class="{{ tenwebShareButtons.getNetworkClass( button ) }}"></i> {{{ tenwebShareButtons.getNetworkTitle( obj ) }}}',
      ]
    );
            ...
            ?>
              <div class="elementor-share-btn__text">
                <span class="elementor-share-btn__title">
                  <?php echo $button['text'] ? $button['text'] : $this->get_networks( $network_name ); ?>
                </span>
              </div>
            <?php
            }
