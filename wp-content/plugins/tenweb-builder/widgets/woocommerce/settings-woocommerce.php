<?php
namespace Tenweb_Builder\Widgets\Woocommerce;

use Elementor\Core\Base\Document;
use Elementor\Controls_Manager;
use Elementor\Core\Kits\Documents\Tabs\Tab_Base;
use \Tenweb_Builder\ElementorPro\Modules\QueryControl\Module as QueryModule;
...
class Settings_Woocommerce extends Tab_Base {
    ...
    public function get_icon() {
        return 'twbb-woocommerce-settings twbb-widget-icon';
    }
