        ...
        <div class="coupon e-cart-section shop_table">
            <div class="form-row coupon-col">
                ...
                <div class="coupon-col-end">
                    <button <?php $this->print_render_attribute_string( 'button_coupon' ); ?> value="<?php esc_attr_e( 'Apply coupon', 'tenweb-builder' ); ?>"><?php esc_attr_e( 'Apply coupon', 'tenweb-builder' ); ?></button>
                </div>
